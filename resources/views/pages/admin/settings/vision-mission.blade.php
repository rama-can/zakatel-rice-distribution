<x-back-layout>
    @section('title'){{ __('Vision Mission') }}@endsection
    @push('styles')
                ...
                <div>
                    <x-admin.form-section action="{{ route('settings.update') }}" enctype="multipart/form-data">
                        ...
                        <x-slot name="description">
                            {{ __('Update Vision & Mission information') }}
                        </x-slot>
                            ...
                            <div class="col-span-6 sm:col-span-6">
                                <div class="col-span-6 sm:col-span-6">
                                    <x-admin.quill-editor
                                        label="Visi"
                                        name="zakatel_visi"
                                        value="{!! $setting['zakatel_visi'] !!}"
                                        placeholder="visi here..." />
                                </div>
                            ...
                            <div class="col-span-6 sm:col-span-6">
                                <div class="col-span-6 sm:col-span-6">
                                    <x-admin.quill-editor
                                        label="Misi"
                                        name="zakatel_misi"
                                        value="{!! $setting['zakatel_misi'] !!}"
                                        placeholder="misi here..." />
                                </div>
                                <x-input-error :messages="$errors->get('zakatel_misi')" class="mt-1" />
                            </div>
                        </x-slot>
                        <x-slot name="actions">
                            <x-button.primary>
